                ...
                <div class="card">
                    <div class="pers">
                        ...
                        <div class="action">
                            ...
                            <a data-bs-toggle="modal" data-bs-target="#UpdatePoste" data-bs-whatever="@getbootstrap" href=""> <i class=" fas fa-solid fa-calendar-minus"></i></a>
                            <div class="modal fade" id="UpdatePoste" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                        ...
                                        <div class="modal-body">
                                            <form action="">
                                                ...
                                                <div class="mb-3">
                                                    <label for="recipient-name" class="col-form-label">Title:</label>
                                                    <input type="text" name="title" class="form-control" id="recipient-name" value="zjfhzufg">
                                                </div>
                                                <div class="file">
                                                    <label for="avatar">Choose a post picture:</label>
                                                ...
                                                <div class="mb-3">
                                                    <label for="message-text" class="col-form-label">Description:</label>
                                                    <textarea class="form-control" id="message-text">dgdgegeegegegeg</textarea>
                                                </div>
                                            </form>
                                        </div>
                                        <div class="modal-footer">
